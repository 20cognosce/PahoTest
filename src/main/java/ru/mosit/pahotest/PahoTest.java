...
public class PahoTest {
    ...
    public static void main(String[] args) throws MqttException {
        ...
        try (MqttClient client = new MqttClient(
            ...
            JsonData jsonData = new JsonData(0.0, 0, 0.0, 0.0, "", "25");
            ...
            client.setCallback(new MqttCallback() {
                ...
                public void messageArrived(String topic, MqttMessage message) {
                    ...
                    Topic param = Topic.valueOf(topic);
                    if (param == Topic.POWER) jsonData.setPower(Double.valueOf(payload));
                    if (param == Topic.MOTION) jsonData.setMotion(Integer.valueOf(payload));
                    if (param == Topic.TEMPERATURE) jsonData.setTemperature(Double.valueOf(payload));
                    if (param == Topic.SOUND) jsonData.setSound(Double.valueOf(payload));
